...
func (b *broker) Subscribe(ctx context.Context, subject, _ string, handler eventbroker.MessageHandler) error {
	r := kafka.NewReader(kafka.ReaderConfig{Brokers: b.brokers, Topic: subject, GroupID: b.group, MinBytes: 1, MaxBytes: 10e6})
	b.mu.Lock()
